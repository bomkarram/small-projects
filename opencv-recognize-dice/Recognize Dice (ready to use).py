...
class RecognizeDice(object):
    def __init__(self, img_src):
        ...
        self.lower_dice_threshold = np.array([205, 0, 0])
        self.upper_dice_threshold = np.array([255, 255, 255])

        self.lower_dots_threshold = np.array([0, 0, 170])
        self.upper_dots_threshold = np.array([255, 255, 255])

        self.dice_min_area = 5000
        self.dots_min_area = 300
...
if __name__ == '__main__':
    recognition = RecognizeDice('images/dices (2).jpg')
